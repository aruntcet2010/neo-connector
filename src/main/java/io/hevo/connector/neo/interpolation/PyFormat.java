 ...
 * formats: {@code %s} (epoch seconds), {@code %s_as_float}, {@code %ms} (epoch millis),
 * {@code %epoch_microseconds}, and {@code %_ms} (milliseconds field, zero-padded to 3).
 */
        ...
        switch (format) {
            ...
            case "%epoch_microseconds":
                return String.valueOf(
                        utc.toEpochSecond() * 1_000_000L + utc.getNano() / 1_000L);
            default:
