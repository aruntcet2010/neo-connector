...
/**
 * Global template functions, mirroring airbyte_cdk/sources/declarative/interpolation/macros.py. All
 * methods are public static so they can be registered as Jinjava EL functions.
 */
