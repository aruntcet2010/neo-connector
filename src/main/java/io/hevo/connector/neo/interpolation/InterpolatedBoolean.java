 ...
 * result is truthy unless it appears in the CDK's FALSE_VALUES list (interpolated_boolean.py): the
 * strings "False", "false", "{}", "[]", "()", "", "0", "0.0", plus false, empty collections, and
 * zero numbers. Defaults to false when the condition is absent or renders empty.
 */
