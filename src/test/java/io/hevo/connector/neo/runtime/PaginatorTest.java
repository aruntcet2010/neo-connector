...
class PaginatorTest {
  ...
  void offsetIncrementAccumulatesAndStops() {
    ...
    // Token injection
    assertEquals(
        Map.of("offset", 2), p.requestOptions(RequestOptionSpec.InjectInto.REQUEST_PARAMETER, 2));
  }
  ...
  void cursorPaginationReadsResponseAndStops() {
    ...
    Paginator.PageContext withCursor =
        new Paginator.PageContext(Map.of("next_cursor", "abc123"), Map.of(), 5, Map.of(), null);
