...
class ReferenceResolverTest {
    ...
    Map<String, Object> manifest =
        ManifestLoader.load(
            """
                        ...
                        """);
    Map<String, Object> resolved = resolver.preprocessManifest(manifest);
    assertEquals(Map.of("k1", "v1", "k2", "override", "k3", "v3"), resolved.get("same"));
  }
    ...
    Map<String, Object> manifest =
        ManifestLoader.load(
            """
                        ...
                        """);
    assertThrows(
        ManifestException.CircularReference.class, () -> resolver.preprocessManifest(manifest));
  }
  ...
  void undefinedReferenceThrows() {
    ...
    assertThrows(
        ManifestException.UndefinedReference.class, () -> resolver.preprocessManifest(manifest));
  }
}
